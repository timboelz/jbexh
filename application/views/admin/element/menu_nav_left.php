				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-md-8">
							...
							<form action="<?php echo site_url('admin/upload'); ?>" method="post" enctype="multipart/form-data" id="form_produk"> 
							
								<div class="form-group">
									<label>Nama Event</label>
									<input name="ket" id="event_name" name="event_name"  class="form-control" >
								</div>
																
								<div class="form-group">
									<label>Keterangan</label>
									<textarea name="event_desc" id="event_desc" class="form-control" rows="3"></textarea>
								</div>
								
								<div class="form-group">
								  <label>Tanggal event</label>
								    <input name="event_date" id="event_date" name="event_name"  class="form-control" >
								</div>
