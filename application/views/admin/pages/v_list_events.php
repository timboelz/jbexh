			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<table data-toggle="table"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true"  data-sort-name="name" data-sort-order="desc">
						<thead>
						    <a class="btn btn-primary btn-xs" href="<?php echo site_url('events/addform') ?>"> Add Event </a>
							<tr>
								<th >Event ID </th>
						        <th >Nama Event</th>
								<th >Alamat Event</th>
                        ...
                        { foreach($listevents->result_array() as $row) 
                          { ?> 
                              <tr>
								...
								<td align="center">
								<div  align="center" >
									<a class="btn btn-success btn-xs" href="<?php echo site_url('events/editform/'.$row['event_id'])?>"><i class="icon-pencil"></i> Edit</a> &nbsp;
