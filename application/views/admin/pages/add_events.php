					...
					<div class="panel-body">
						...
						<form action="<?php echo site_url('events/upload'); ?>" method="post" enctype="multipart/form-data" id="form_produk"> 
								...
								<div class="form-group">
									...
									<input type="text" required name="event_name" class="form-control" data-toggle="tooltip" data-placement="top" title="Nama Event Tidak Boleh Kosong"  >
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<label>Tanggal Event</label>
									 <input class="form-control" required name="event_date" id="event_date" data-date-format="dd-mm-yyyy">         
								</div>
								...
								<div class="form-group">
									...
									<input type="text" required name="event_pic_name" class="form-control" placeholder="Nama Brosur" >
									<input required type="file" name="event_pic">
									 
								</div>
								<div class="form-group">
									<label>Denah Stand</label>
									<input type="text" required name="event_pic_plan_name" class="form-control" placeholder="Nama Brosur Denah ">
