                        ...
                        { foreach($listevents->result_array() as $row) 
                          { ?> 
                              <tr>
								  ...
								  <td>
									<img src="<?php echo base_url('asset/brosur_image/'.$row['event_pic'])?>" width="40" />
								  </td>
								  <td>
									<img src="<?php echo base_url('asset/brosur_image/'.$row['event_pic_plan'])?>" width="40" />
								  </td>
                              <td align="center">
                              <div  align="center" >
<a class="btn btn-small" href="<?php echo site_url('events/editform/'.$row['event_id'])?>"><i class="icon-pencil"></i> Edit</a>
<a class="btn btn-small" href="<?php echo site_url('events/deleteevents/'.$row['event_id']);?>"
