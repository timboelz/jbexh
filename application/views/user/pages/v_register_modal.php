...
<html>
	<head>
		...
		<link rel="stylesheet" href="<?php echo site_url('asset/src/bootstrap-wizard.css')?>" />
		<link rel="stylesheet" href="<?php echo site_url('asset/chosen/chosen.css')?>" />
		<style type="text/css">
			.wizard-modal p {
				margin: 0 0 10px;
				padding: 0;
	...
	<body style="padding:30px;">
		...
		<div class="wizard" id="satellite-wizard" data-title="Create Server">
			...
			<div class="wizard-card" data-cardname="group">
				...
				<div class="wizard-input-section">
					...
					<img class="wizard-group-list" src="<?php echo site_url('asset/img/groups.png')?>" />
				</div>
			</div>
			...
			<div class="wizard-card wizard-card-overlay">
				...
				<div class="wizard-ns-detail hide">
					...
					<ul id="wizard-ns-detail-servers">
						<li><img src="<?php echo site_url('asset/img/folder.png')?>"/>Corporate sites</li>
						<li><img src="<?php echo site_url('asset/img/folder.png')?>"/>dt01.sat.medtelligent.com</li>
						<li><img src="<?php echo site_url('asset/img/server_new.png')?>"/>alisonline.com</li>
		...
		<script type="text/javascript" src="<?php echo site_url('asset/js/jquery-1.10.0.min.js')?>"></script>
		<script type="text/javascript" src="<?php echo site_url('asset/chosen/chosen.jquery.js')?>"></script>
		<script type="text/javascript" src="<?php echo site_url('asset/js/bootstrap/js/bootstrap.min.js')?>"></script>
		<script type="text/javascript" src="<?php echo site_url('asset/js/prettify.js')?>"></script>
		<script type="text/javascript" src="<?php echo site_url('asset/src/bootstrap-wizard.js')?>"></script>
