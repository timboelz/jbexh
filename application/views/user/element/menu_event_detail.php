		...
		<? } ?>
               ...
               <!--
				...
				-->
				 ...
				 <div class="wel" style="background-color:rgb(255,255,255)" > 
						<h2>Pendaftaran Perusahaan</h2>
						
						<p>
						Bila Perusahaan anda ingin menjadi partner kami, maka daftarkan sekarang.....!
						<a class="btn btn-primary" href="<?php echo base_url('user/addCompReg/'.$row['event_id']); ?>" >Reg</a> 
						</p>
