	...
	<script type="text/javascript"> 
        jQuery(document).ready(function() { 
			jQuery('#form-upload').on('submit', function(e) {
				...
				jQuery("#output").html('<div style="padding:10px"><img src="<?php echo base_url('asset/images/loading.gif'); ?>" alt="Please Wait"/> <span>Mengunggah...</span></div>');
...
<div id="container">
	...
	<div id="body">
		<div align="center" id="wrapper">
			<form action="<?php echo site_url('uploadcek/upload'); ?>" method="post" enctype="multipart/form-data" id="form-upload">
